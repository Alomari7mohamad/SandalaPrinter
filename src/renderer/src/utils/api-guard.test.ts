...
const validApi = () => ({
  ...
  catalog: { listCategories: vi.fn(), saveCategory: vi.fn(), listServices: vi.fn(), saveService: vi.fn(), setServiceActive: vi.fn(), deleteService: vi.fn() },
  ...
  inventory: { list: vi.fn(), adjust: vi.fn(), updateSettings: vi.fn(), createItem: vi.fn() },
