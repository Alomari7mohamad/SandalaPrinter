import { ArrowDownToLine, ArrowUpFromLine, Boxes, Edit3, FolderPlus, LoaderCircle, PackageCheck, PackageX, Plus, Search, Settings2, Trash2, TriangleAlert, X } from 'lucide-react'
