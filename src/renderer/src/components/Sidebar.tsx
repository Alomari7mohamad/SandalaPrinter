...
import { BookOpenText, Boxes, CalendarClock, ChartNoAxesCombined, ClipboardList, House, PackageOpen, PanelRightClose, Plus, Settings, ShoppingBasket, Tags, UserRound } from 'lucide-react'
