...
const settingsSchema = z.object({
  ...
  supplierIds: z.array(z.string().min(2)).max(30).optional(), barcode: z.string().trim().max(100).nullable().optional(),
